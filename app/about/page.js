...
export const revalidate = 46800;

const cabin = await getCabins();

export default function Page() {
  return (
    <div className="grid grid-cols-2 items-center gap-x-24 gap-y-32 text-lg sm:grid-cols-5">
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            Since 1962, Istay has been a cherished family-run retreat. Started
          ...
          <p>
            Over the years, we&apos;ve maintained the essence of Istay, blending
            the timeless beauty of the mountains with the personal touch only a
            family business can offer. Here, you&apos;re not just a guest;
            you&apos;re part of our extended family. So join us at The Wild
